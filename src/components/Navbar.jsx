  ...
  return (
    ...
    <div className='lg:w-1/2 md:w-2/3 sm:w-9/12 w-11/12  mx-auto text-center mt-14'>
        <div className='  text-white flex flex-col space-y-6'>
            ...
            <p className='font-light lg:text-2xl md:text-xl sm:text-lg text-sm'>Determine your ACFT (Army Combat Fitness Test) score with our updated calculator and the most recent scoring charts.
</p>
        </div>
    </div>
    </div>
