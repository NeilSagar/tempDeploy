  ...
  return (
    <div className='flex flex-col items-center text-left space-y-10 my-10'>
      ...
      <div>
        ...
        <p className='lg:w-1/2 md:w-2/3 w-11/12  mx-auto font-light my-5  tracking-wide leading-8'>
        ...
        {/* heading 2.3 */}
        <div className='my-7'>
        <h2 className='lg:w-1/2 md:w-2/3 w-11/12 mx-auto my-5 lg:text-4xl md:text-4xl sm:text-2xl text-xl'>
        ...
        <p className='lg:w-1/2 md:w-2/3 w-11/12  mx-auto mt-5 text-lg  tracking-wide leading-8 font-medium text-gray-800'>
        Understand the Test Components: The ACFT consists of six events:</p>
        <div className='lg:w-1/2 md:w-2/3 w-11/12  mx-auto mb-5 font-light  tracking-wide leading-8'>
        ...
        <div className='lg:w-1/2 md:w-2/3 w-11/12  mx-auto my-5 font-light  tracking-wide leading-8'>
            <ul className='list-disc pl-10'>
      ...
      <div>
      <div className='my-7'>
        <h2 id='readmoreview' className='lg:w-1/2 md:w-2/3 w-11/12 mx-auto lg:text-4xl md:text-4xl sm:text-2xl text-xl'>
        ACFT Score Tool: Assess Your Army Combat Fitness Test Performance 
        </h2>
        <p className='lg:w-1/2 md:w-2/3 w-11/12  mx-auto my-5 font-light  tracking-wide leading-8'>
