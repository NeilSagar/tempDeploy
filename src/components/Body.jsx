...
const images =[bookmark,cloud,ok, plus];
  return (
    <div className=' mt-5 flex flex-col items-center text-center space-y-10'>
      <h2 className='lg:w-1/2 md:w-2/3 w-11/12 mx-auto lg:text-4xl md:text-4xl sm:text-2xl text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing </h2>
      ...
      <h2 className='lg:w-1/2 md:w-2/3 w-11/12 mx-auto lg:text-4xl md:text-4xl sm:text-2xl text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do</h2>
